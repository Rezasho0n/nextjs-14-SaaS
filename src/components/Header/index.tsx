                  ...
                  {[0, 1, 2].map((index) => (
                    <span
                      ...
                      className={`relative my-1.5 block h-0.5 w-[30px] transition-all duration-300 
                        ${navbarOpen && index === 0 ? "top-[7px] rotate-45" : ""}
                        ${navbarOpen && index === 1 ? "opacity-0" : ""}
                        ${navbarOpen && index === 2 ? "top-[-8px] -rotate-45" : ""}
                ...
                >
                  <ul className="block lg:ml-8 lg:flex lg:gap-x-8 xl:ml-14 xl:gap-x-12">
                    {menuData.map((menuItem, index) => {
                      // Check if the menu item is "My Data" and if the user is not signed in
                      if (menuItem.title === "My Data" && !user) {
                        return null; // Don't render "My Data" if user is not signed in
                      }
